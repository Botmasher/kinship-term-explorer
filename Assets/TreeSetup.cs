...
public class TreeSetup : MonoBehaviour {
	...
	Dictionary<string, GameObject> PlaceMembers() {
		...
		z.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		m.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		mm.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		fm.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		fz.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		mz.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		mbd.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		mzd.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		fbd.GetComponent<FamilyMember> ().ToggleSexMarking ();
		...
		fzd.GetComponent<FamilyMember> ().ToggleSexMarking ();
